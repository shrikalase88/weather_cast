...
class LocationDetailScreen extends ConsumerWidget {
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            ...
            Text(location.name, style: const TextStyle(fontWeight: FontWeight.w900)),
          ],
        ),
            ...
            children: [
              weatherAsync.when(
                data: (weather) => SkeuCard(
                  ...
                  child: Column(
                    children: [
                      const Text('REAL-TIME WEATHER METRICS', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w900, fontSize: 10, letterSpacing: 1.5)),
                      ...
                      Text(
                       ...
                       // Real-time metrics grid (same as home screen)
                       Row(
                      ...
                      _buildMetricRow('AIR QUALITY INDEX', _getAQIDesc(weather.airIndex)),
                    ],
                  ),
                ),
                loading: () => const Center(child: CircularProgressIndicator()),
                error: (err, _) => const Center(child: Text('Data currently unavailable')),
              ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: 70,
                                    child: Text(
                                      _getWeatherStatusLabel(day.description),
  ...
  String _getWeatherStatusLabel(String description) {
    ...
    if (lowerDesc.contains('rain') || lowerDesc.contains('drizzle')) {
      ...
      if (lowerDesc.contains('heavy') || lowerDesc.contains('moderate')) {
        return 'H. RAIN';
      }
      return 'RAINY';
    }
    ...
    if (lowerDesc.contains('smoke') || lowerDesc.contains('dust')) {
      return 'HAZY';
    }
